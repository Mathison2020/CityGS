...
TEST_PATH="data/nanjingraocheng_A"

COARSE_CONFIG="my_scene_coarse"
CONFIG="my_scene"

out_name=""  # i.e. TEST_PATH.split('/')[-1]
max_block_id=7  # i.e. x_dim * y_dim * z_dim - 1
port=4041
...
gpu_id=$(get_available_gpu)
echo "GPU $gpu_id is available."
CUDA_VISIBLE_DEVICES=$gpu_id python metrics_large.py -m output/$CONFIG -t "nanjingraocheng_A"
"
